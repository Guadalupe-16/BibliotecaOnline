...
<body class="min-h-screen flex items-center justify-center px-4 py-8"
    ...
    {{-- Tarjeta principal --}}
    <div
        x-data="{ cargado: false, hovering: false, mostrarPass: false, mostrarConfirm: false, aceptaTerminos: false }"
    ...
    >
        <div class="bg-[#13131f]/90 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl shadow-black/50">
            ...
            <div class="flex flex-col items-center mb-6">
                ...
                <h1 class="text-white text-2xl font-semibold tracking-tight">Crear cuenta</h1>
                <p class="text-white/40 text-sm mt-1">Únete a la Biblioteca Digital Online</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <label for="nombre" class="block text-white/60 text-xs font-medium mb-2 uppercase tracking-widest">
                            Nombre(s)
                        </label>
                        <input
                            id="nombre"
                    ...
                    <div>
                        <label for="apellidos" class="block text-white/60 text-xs font-medium mb-2 uppercase tracking-widest">
                            Apellidos
                        </label>
                        <input
                            id="apellidos"
                ...
                {{-- Nombre de usuario --}}
                <div>
                    <label for="username" class="block text-white/60 text-xs font-medium mb-2 uppercase tracking-widest">
                        Nombre de usuario
                    </label>
                    <input
                        id="username"
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                required
                                class="w-full bg-white/5 border border-white/10 text-white placeholder-white/20
                                       rounded-xl px-4 py-3 pr-10 text-sm outline-none
                                       focus:border-indigo-500/60 focus:ring-1 focus:ring-indigo-500/30
                                       transition-all duration-300"
                            >
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-white/60 text-xs font-medium mb-2 uppercase tracking-widest">
                            Confirmar
                        </label>
                        <div class="relative">
                            <input
                                ...
                                class="w-full bg-white/5 border border-white/10 text-white placeholder-white/20
                                       ...
                                       transition-all duration-300"
                            >
                            <button type="button" @click="mostrarConfirm = !mostrarConfirm"
                                class="absolute right-3 top-1/2 -translate-y-1/2 text-white/30 hover:text-white/60 transition-colors">
                                <svg x-show="!mostrarConfirm" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                </svg>
                                <svg x-show="mostrarConfirm" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex items-start gap-3">
                    <input
                        ...
                        class="mt-1 w-4 h-4 rounded border-white/20 bg-white/5 text-indigo-500 focus:ring-indigo-500/30"
                    >
                    <label for="terminos" class="text-white/40 text-xs leading-relaxed">
                        Acepto los <a href="#" class="text-indigo-400 hover:text-indigo-300 transition-colors">términos y condiciones</a>
                    </label>
                </div>
                ...
                <button
                    ...
                    :style="hovering && aceptaTerminos ? 'background: linear-gradient(135deg, #4f46e5, #7c3aed); box-shadow: 0 0 30px rgba(99,102,241,0.4)' : 'background: linear-gradient(135deg, #6366f1, #8b5cf6)'"
                >
                    Crear cuenta
                </button>
