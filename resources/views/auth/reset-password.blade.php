...
<head>
    ...
    <title>Nueva Contraseña - Biblioteca Digital</title>
...
<body class="min-h-screen flex items-center justify-center px-4"
    ...
    {{-- Tarjeta principal --}}
    <div
        x-data="{ cargado: false, hovering: false, mostrarPass: false, mostrarConfirm: false }"
    ...
    >
        <div class="bg-[#13131f]/90 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl shadow-black/50">
            ...
            <div class="flex flex-col items-center mb-8">
                ...
                <h1 class="text-white text-2xl font-semibold tracking-tight">Nueva contraseña</h1>
                <p class="text-white/40 text-sm mt-1 text-center">Ingresa y confirma tu nueva contraseña</p>
            </div>
            ...
            @if($errors->any())
                <div x-data="{ visible: true }"
                     x-show="visible"
                     x-transition
                     class="mb-6 p-4 bg-red-500/10 border border-red-500/30 rounded-xl text-red-400 text-sm space-y-1">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" @click="mostrarPass = !mostrarPass"
                            ...
                            <svg x-show="!mostrarPass" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" @click="mostrarConfirm = !mostrarConfirm"
                                class="absolute right-3 top-1/2 -translate-y-1/2 text-white/30 hover:text-white/60 transition-colors">
                            <svg x-show="!mostrarConfirm" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                            </svg>
                            <svg x-show="mostrarConfirm" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
